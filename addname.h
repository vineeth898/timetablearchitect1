...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->panel1->Size = System::Drawing::Size(446, 2111);
			...
			this->label1->Location = System::Drawing::Point(567, 156);
			...
			this->textBox1->Location = System::Drawing::Point(574, 224);
			...
			this->panel3->Location = System::Drawing::Point(577, 261);
			...
			this->label2->Location = System::Drawing::Point(567, 289);
			...
			this->panel4->Location = System::Drawing::Point(577, 395);
			...
			this->comboBox1->Location = System::Drawing::Point(574, 350);
			...
			this->label3->Location = System::Drawing::Point(570, 461);
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(573, 577);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(577, 801);
			...
			// button3
			// 
			this->button3->Location = System::Drawing::Point(577, 746);
			...
			// button4
			// 
			this->button4->Location = System::Drawing::Point(573, 689);
			...
			// button5
			// 
			this->button5->Location = System::Drawing::Point(573, 630);
			...
			// button6
			// 
			this->button6->Location = System::Drawing::Point(577, 852);
			...
			// button7
			// 
			this->button7->Location = System::Drawing::Point(719, 577);
			...
			// button8
			// 
			this->button8->Location = System::Drawing::Point(719, 630);
			...
			// button9
			// 
			this->button9->Location = System::Drawing::Point(719, 689);
			...
			// button10
			// 
			this->button10->Location = System::Drawing::Point(719, 746);
			...
			// button11
			// 
			this->button11->Location = System::Drawing::Point(719, 801);
			...
			// button12
			// 
			this->button12->Location = System::Drawing::Point(719, 852);
			...
			// button13
			// 
			this->button13->Location = System::Drawing::Point(866, 852);
			...
			// button14
			// 
			this->button14->Location = System::Drawing::Point(866, 801);
			...
			// button15
			// 
			this->button15->Location = System::Drawing::Point(866, 746);
			...
			// button16
			// 
			this->button16->Location = System::Drawing::Point(866, 689);
			...
			// button17
			// 
			this->button17->Location = System::Drawing::Point(866, 630);
			...
			// button18
			// 
			this->button18->Location = System::Drawing::Point(866, 577);
			...
			// button19
			// 
			this->button19->Location = System::Drawing::Point(1008, 852);
			...
			// button20
			// 
			this->button20->Location = System::Drawing::Point(1008, 801);
			...
			// button21
			// 
			this->button21->Location = System::Drawing::Point(1008, 746);
			...
			// button22
			// 
			this->button22->Location = System::Drawing::Point(1008, 689);
			...
			// button23
			// 
			this->button23->Location = System::Drawing::Point(1008, 630);
			...
			// button24
			// 
			this->button24->Location = System::Drawing::Point(1008, 577);
			...
			// button25
			// 
			this->button25->Location = System::Drawing::Point(1145, 852);
			...
			// button26
			// 
			this->button26->Location = System::Drawing::Point(1145, 801);
			...
			// button27
			// 
			this->button27->Location = System::Drawing::Point(1145, 746);
			...
			// button28
			// 
			this->button28->Location = System::Drawing::Point(1145, 689);
			...
			// button29
			// 
			this->button29->Location = System::Drawing::Point(1145, 630);
			...
			// button30
			// 
			this->button30->Location = System::Drawing::Point(1145, 577);
			...
			// button31
			// 
			this->button31->Location = System::Drawing::Point(1287, 852);
			...
			// button32
			// 
			this->button32->Location = System::Drawing::Point(1287, 801);
			...
			// button33
			// 
			this->button33->Location = System::Drawing::Point(1287, 746);
			...
			// button34
			// 
			this->button34->Location = System::Drawing::Point(1287, 689);
			...
			// button35
			// 
			this->button35->Location = System::Drawing::Point(1287, 630);
			...
			// button36
			// 
			this->button36->Location = System::Drawing::Point(1287, 577);
			...
			// button37
			// 
			this->button37->Location = System::Drawing::Point(0, 0);
			...
			this->button38->Location = System::Drawing::Point(1369, 943);
			...
			this->button39->Font = (gcnew System::Drawing::Font(L"Segoe UI Semibold", 12, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button39->Location = System::Drawing::Point(1167, 943);
